            ...
            <section className="mt-10 border-t pt-8">
              ...
              {registration ? (
                <div className="rounded-2xl border bg-primary/5 p-6 md:p-8">
                  ...
                  {/* Registration ID */}
                  <div className="mx-auto mt-6 max-w-md rounded-xl border bg-background p-5 text-center">
                ...
                <div>
                  ...
                  <button
                    ...
                    className="w-full rounded-xl bg-primary px-6 py-4 text-sm font-semibold text-primary-foreground transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    {registering
                      ? "Registering..."
                      : "Register Now"}
